#!/usr/bin/env python3
"""mindfulness-meditation runner — thin wrapper over _shared/llm_wrapper.py."""
import sys
...
if __name__ == "__main__":
    ...
    args = ap.parse_args()
    result = run_skill("mindfulness-meditation", user_query=args.query, backend=args.backend)
