#!/usr/bin/env python3
"""market-research-reports runner — thin wrapper over _shared/llm_wrapper.py."""
import sys
...
if __name__ == "__main__":
    ...
    args = ap.parse_args()
    result = run_skill("market-research-reports", user_query=args.query, backend=args.backend)
