#!/usr/bin/env python3
"""aminer-academic-search runner — thin wrapper over _shared/llm_wrapper.py."""
import sys
...
if __name__ == "__main__":
    ...
    args = ap.parse_args()
    result = run_skill("aminer-academic-search", user_query=args.query, backend=args.backend)
