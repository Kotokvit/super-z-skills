#!/usr/bin/env python3
"""visual-design-foundations runner — thin wrapper over _shared/llm_wrapper.py."""
import sys
...
if __name__ == "__main__":
    ...
    args = ap.parse_args()
    result = run_skill("visual-design-foundations", user_query=args.query, backend=args.backend)
